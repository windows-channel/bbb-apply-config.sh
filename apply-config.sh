...
sudo sed -i 's/^meetingExpireIfNoUserJoinedInMinutes=.*/meetingExpireIfNoUserJoinedInMinutes=43800/' /usr/share/bbb-web/WEB-INF/classes/bigbluebutton.properties
sudo sed -i 's/^meetingExpireWhenLastUserLeftInMinutes=.*/meetingExpireWhenLastUserLeftInMinutes=43800/' /usr/share/bbb-web/WEB-INF/classes/bigbluebutton.properties
