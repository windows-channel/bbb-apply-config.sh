...
sudo sed -i 's/^meetingExpireIfNoUserJoinedInMinutes=.*/meetingExpireIfNoUserJoinedInMinutes=1440/' /usr/share/bbb-web/WEB-INF/classes/bigbluebutton.properties
sudo sed -i 's/^meetingExpireWhenLastUserLeftInMinutes=.*/meetingExpireWhenLastUserLeftInMinutes=1440/' /usr/share/bbb-web/WEB-INF/classes/bigbluebutton.properties
