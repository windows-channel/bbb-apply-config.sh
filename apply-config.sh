...
sudo sed -i 's/^meetingExpireIfNoUserJoinedInMinutes=.*/meetingExpireIfNoUserJoinedInMinutes=4320/' /usr/share/bbb-web/WEB-INF/classes/bigbluebutton.properties
sudo sed -i 's/^meetingExpireWhenLastUserLeftInMinutes=.*/meetingExpireWhenLastUserLeftInMinutes=4320/' /usr/share/bbb-web/WEB-INF/classes/bigbluebutton.properties
